(function ()
{
    ...
    /** @ngInject */
    function msScrollDirective($timeout, msScrollConfig, msUtils, appConfig)
    {
        return {
            restrict: 'AE',
            compile : function (tElement)
            {
                ...
                if ( appConfig.getConfig('disableCustomScrollbars') )
                {
                    return;
                }
                ...
                if ( appConfig.getConfig('disableCustomScrollbarsOnMobile') && msUtils.isMobile() )
                {
                    return;
                }
